...
async function seed() {
  ...
  await pool.query(`
    INSERT INTO restaurants (name, slug, logo_url, address, phone, currency, primary_color, is_active)
    VALUES ('Le Palais', 'le-palais', '', '123 Rue Principale, Dakar', '+221 77 123 45 67', 'FCFA', '#D4AF37', true)
