    ...
    <div className="relative min-h-screen bg-black overflow-hidden">
      ...
      <div className="relative z-10 pb-24">
        <div className={`px-4 pt-12 pb-8 text-center ${visible ? 'animate-fade-in-up' : 'opacity-0'}`}>
          <div className="inline-flex items-center justify-center w-24 h-24 rounded-full bg-gradient-to-br from-gold-500/20 to-gold-500/5 border border-gold-500/20 mb-6 animate-float animate-glow" style={{ borderColor: primaryColor + '33' }}>
            {logoUrl ? (
